...
export const BeginGetUserAction = createAction(
  UserActionType.BeginGetUserAction
);
...
export const ErrorUserAction = createAction(
  UserActionType.ErrorUserAction,
  props<Error>()
);
...
export const BeginGetGeneralInfoAction = createAction(
  UserActionType.BeginGetUserAction
);
